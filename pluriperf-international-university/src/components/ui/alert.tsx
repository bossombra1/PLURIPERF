...
const alertVariants = cva(
  'relative w-full rounded-[var(--radius)] border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-text-muted [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        default: 'bg-surface text-text-primary border-border-ui',
